---
layout: post
title: "Paper Summary: <Paper Title Here>"
published: false
categories: [paper-notes, deep-learning]
mathjax: true
---
...
{% raw %}{% include paper_diagram.html
   ...
   caption="High-level view of the method."
%}{% endraw %}
...
_Starter:_  
Write the main equations from the paper here using MathJax.
...
The reverse (or main) process exists because **…**

## 6.2 Why the model works  
_Starter:_  
This approach works because **…**  
The modeling assumptions help **…**  
The learning algorithm/network learns **…**
...
_Starter:_  
Write simplified, paper-faithful pseudocode here.
...
## 8.1 Forward / Data Process
```python
def forward_process(x0, t, schedule):
    """
    Starter:
    - Describe what this step does
    - Reference the corresponding equation
    """
    # your code here
    return xt
```

## 8.2 Model / Denoising Step

```python
def model_step(x, t, model):
    """
    Starter:
    - Apply the neural network / update rule
    - Explain the mapping it learns
    """
    # your code here
    return x_next
```
