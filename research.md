...
All three studies extend the **[ScalaTion](https://github.com/scalation/scalation_2.0) framework** (developed by Dr. John A. Miller and collaborators) and validate against real-world sensor data from the California Performance Measurement System ([PeMS](https://pems.dot.ca.gov/)).
...
**Title:** "Toward Validated Digital Twins of Urban Freeways: Comparative Calibration of Car-Following Models Against Loop-Detector Data"
...
**Approach:**
- 2 car-following models (IDM, Gipps) x 5 optimization algorithms (SPSA, SPSA with momentum, Nelder-Mead, Genetic Algorithm, Differential Evolution)
...
- Corridor-level validation: 5 detector stations x 4 lanes on US-101
...
### In Preparation
2. **Bishi, K.R.**, Miller, J.A. (2026). "Toward Validated Digital Twins of Urban Freeways: Comparative Calibration of Car-Following Models Against Loop-Detector Data." *Winter Simulation Conference (WSC)*. [Target: April 2026]
...
**Advisor:** Dr. John A. Miller  
**Lab:** ScalaTion Research Group, [University of Georgia](https://www.uga.edu/)
